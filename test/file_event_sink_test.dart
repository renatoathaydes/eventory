  ...
  group('FileEventSink writes', () {
    ...
    test('batched events', () async {
      await sink.add(Event(
          'hello', Attribute(["p1", "p2"]), 42, DateTime.parse('2010-02-03')));
      await sink.addBatch([
        Event('hello', Attribute(['a']), "A", DateTime.parse('2010-02-03')),
        Event('hello', Attribute(['b']), "B", DateTime.parse('2010-02-03')),
        Event('hello', Attribute(['c']), "C", DateTime.parse('2010-02-04')),
        Event('bye', Attribute(['d']), "DD", DateTime.parse('2010-02-05')),
        Event('bye', Attribute(['e']), "EE", DateTime.parse('2010-02-06')),
        Event('bye', Attribute(['f']), "FF", DateTime.parse('2010-02-07')),
      ]);
      final fileContents = await sink.file.readAsString();
